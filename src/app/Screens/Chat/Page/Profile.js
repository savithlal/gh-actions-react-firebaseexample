  ...
  return (
    <>
      <SafeAreaView style={style.container}>
        <ActivityIndicator animating={state.updating} size="large" color={Theme.PRIMARY_GREEN} />
        <View style={[style.loginForm]}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.85}
            style={[style.loginButton, { backgroundColor: state.updating ? '#2ddd7f' : Theme.PRIMARY_GREEN }]}
