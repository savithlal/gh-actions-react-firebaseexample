    ...
    <>
      <SafeAreaView style={style.container}>
        <View style={style.logoContainer}>
          ...
          <ActivityIndicator animating={state.connecting} size="large" color={Theme.PRIMARY_GREEN} />
        </View>
        <View style={[style.loginForm]}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.85}
            style={[style.loginButton, { backgroundColor: state.connecting ? Theme.PRIMARY_GREY : Theme.PRIMARY_GREEN }]}
            onPress={connect}
          >
